        ...
        <>
            <div className="flex items-center mb-10 mt-24 h-screen">
                <div className="w-full gap-32 my-10 flex flex-col sm:flex-row justify-between items-center px-8 sm:px-12 lg:px-16">
                    ...
                    <div className="sm:w-2/3 flex flex-col gap-5 text-sm sm:text-base text-slate-600 opacity-80 mt-7">
                        <p>
                        ...
                        <p className="text-slate-800 font-medium">
                            A energiasolar surge como uma proposta para transformar esse cenário, oferecendo uma maneira de gerar eletricidade de forma responsável, minimizando os impactos ambientais e promovendo o equilíbrio entre progresso e sustentabilidade.
                        </p>
                        <p>
                            Nesta plataforma, você terá a oportunidade de mergulhar em seu sistema de paineis solares, registrando seu dispositivo Sun Catcher e acompanhando em tempo real os dados colhidos e enviados ao seu painel solar.
                        </p>
                    </div>
                </div>
            </div>
